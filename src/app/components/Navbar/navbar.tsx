  ...
  return (
    <div>
      <div className='flex  flex-row px-5 bg-[#f8f8f8] shadow items-center py-2 justify-between' >
        <div >
       <Link href={"/"}> <Image width={500} height={500} alt="logo"  src="/images/asha-logo.png" className='w-[80px] h-[80px] '  />
       </Link>  </div>
        <div className='flex text-xl w-1/3 justify-between'>
            ...
            <Link href={"/blog"}><p className='ml-5 text-center cursor-pointer hover:text-red-300'>Blog</p></Link>
